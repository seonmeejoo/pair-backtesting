...
# ---------------------------------------------------------
# 2. 그룹핑 정의 (Logic Engine)
# ---------------------------------------------------------
# 사용자가 정의한 4대 그룹 매핑
RELATIONSHIP_MAP = [
    # 1. 지주사 vs 핵심 자회사 (Parent-Child)
    ({'SK', 'SK하이닉스'}, '👨‍👦 지주-자회사'),
    ({'LG', 'LG전자'}, '👨‍👦 지주-자회사'),
    ({'LG', 'LG화학'}, '👨‍👦 지주-자회사'),
    ({'POSCO홀딩스', 'POSCO퓨처엠'}, '👨‍👦 지주-자회사'),
    ({'CJ', 'CJ제일제당'}, '👨‍👦 지주-자회사'),
    ({'LS', 'LS ELECTRIC'}, '👨‍👦 지주-자회사'),

    # 2. 우선주 vs 보통주 (Preferred-Common)
    ({'삼성전자', '삼성전자우'}, '⚡ 본주-우선주'),
    ({'현대차', '현대차2우B'}, '⚡ 본주-우선주'),
    ({'LG화학', 'LG화학우'}, '⚡ 본주-우선주'),

    # 3. 업종 내 경쟁사 (Rivals)
    ({'삼성전자', 'SK하이닉스'}, '⚔️ 반도체 경쟁'),
    ({'현대차', '기아'}, '⚔️ 자동차 경쟁'),
    ({'HD현대중공업', '삼성중공업'}, '⚔️ 조선 경쟁'),
    ({'한화오션', '삼성중공업'}, '⚔️ 조선 경쟁'),
    ({'LG에너지솔루션', '삼성SDI'}, '⚔️ 배터리 경쟁'),
    ({'LG에너지솔루션', '에코프로비엠'}, '⚔️ 배터리 경쟁'),
    ({'NAVER', '카카오'}, '⚔️ 플랫폼 경쟁'),
    ({'KB금융', '신한지주'}, '⚔️ 금융 경쟁'),
    ({'하나금융지주', '우리금융지주'}, '⚔️ 금융 경쟁'),

    # 4. 밸류체인 (Supply Chain)
    ({'SK하이닉스', '한미반도체'}, '🔗 밸류체인(HBM)'),
    ({'삼성전자', '삼성전기'}, '🔗 밸류체인(부품)'),
    ({'LG전자', 'LG이노텍'}, '🔗 밸류체인(부품)')
]
